# NPU Operators support list (AX637)
...
| Cos                   | Unlimited                                                                                                                                            |
| CumSum                | - exclusive: Currently only supports 0 <br> - reverse: Currently only supports 0                                                                                                                                                      |
| DepthToSpace          | - blocksize: Unlimited <br> - mode: Unlimited                                                                                                                                                      |
| Div                   | Unlimited                                                                                                                                            |
| Elu                   | Unlimited                                                                                                                                            |
| Equal                 | Unlimited                                                                                                                                            |
| Erf                   | Unlimited                                                                                                                                            |
...
| LayerNormalization    | axis: Currently only supports -1 (i.e., the last dimension)                                                                                          |
| LeakyRelu             | Unlimited                                                                                                                                            |
| Less                  | Unlimited                                                                                                                                            |
...
| RoiAlign              | sampling_ratio: Only supports non-zero                                                                                                               |
...
| SpatialTransformer    | Interpolation mode: "bilinear", Border mode: "constant"(value is 0)                                                                                  |
