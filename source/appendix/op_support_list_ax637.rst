...
+-----------------------+---------------------------------------------+
| LayerNormalization    | axis: Currently only supports -1 (i.e., the |
|                       | last dimension)                             |
+-----------------------+---------------------------------------------+
| LeakyRelu             | Unlimited                                   |
+-----------------------+---------------------------------------------+
...
+-----------------------+---------------------------------------------+
| PRelu                 | For 4D tensor input, the channel dimension  |
|                       | must be the second dimension,               |
|                       | and the slope shape Currently only supports |
|                       | (channel,)                                  |
|                       | or(1, channel, 1, 1)                        |
+-----------------------+---------------------------------------------+
