...
.. code-block:: shell
    ...
    pulsar2 build --target_hardware AX637 --input model/mobilenetv2-sim.onnx --output_dir output --config config/mobilenet_v2_build_config.json
